...
export default function Settings() {
  ...
  return (
    <AppLayout
      ...
      action={
        <button form="settings-form" type="submit" disabled={busy} className="q-btn-primary" data-testid="save-settings-btn">{busy ? t("settings.saving") : t("settings.save")}</button>
      }
    >
